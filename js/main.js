$(document).ready(function() {
    ...
    $('.generator_sound_checkbox .switchery').click(function() {
        ...
        if (generator_sound) {
            $('.sound_icon_trg').addClass('icon--green').html('<div class="fa fa-volume-up"></div>');
        } else {
            $('.sound_icon_trg').removeClass('icon--green').html('<div class="fa fa-volume-off"></div>');
        }
    });
    ...
    $('button, .btn').click(function() {
        ...
        if (generator_sound && !is_disabled) {
            ion.sound.play("swash");
        }
    });
