$(document).ready(function() {
    ...
    var last_activity = {
        ...
        add_activity: function() {
            $('.recent_activity__items').prepend('<div class="recent_activity__item"><div class="recent_activity__nickname">' + last_activity.get_random_from_items(last_activity.get_nicknames()) + '</div><div class="coin_value"><div class="coin_value__items"><div class="coin_value__item"><div class="coin_value__icon coin_value__icon--Diamonds"></div><div class="coin_value__value">' + last_activity.get_random_from_items(last_activity.get_values()) + ' Diamonds</div></div><div class="coin_value__item"><div class="coin_value__icon coin_value__icon--green"></div><div class="coin_value__value">' + last_activity.get_random_from_items(last_activity.get_values()) + ' Coins</div></div></div></div></div>');
